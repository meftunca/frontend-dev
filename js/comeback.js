(function($) {
    ...
    $.fn.accordion = function() {
        ...
        $(this).click(function() {
            ...
            $(this).siblings(submenu).toggleClass("show").slideToggle("slow");
        });
    ...
    $.fn.fileput = function() {
        ...
        this.click(function() {
            var item = $(this).parents(".fileput").find("input").filter("[type=file]");
    ...
    $.fn.dropdown = function() {
        var dropdown = "dropdown",
            ...
            menu = ".dropdown-menu",
            query = $(this).parents("*").hasClass("navbar"),
            query2 = $(this).parents("*").hasClass("sidebar");
        this.click(function(e) {
            var content = $(this).siblings(".dropdown-menu");
            if ($(".dropdown-toggle[data-collapse=dropdown]") && window.innerWidth <= 768) {
                content.slideToggle('fast');
            } else if (window.innerWidth >= 768 && query == false || query2 == false) {
    ...
    $.fn.modal = function() {
        ...
        this.click(function() {
            ...
            $(".modal[data-type=" + type + "]").find(close).click(function() {
                $(this).parents(modal).children('.modal-content').addClass("out").animate({
                    opacity: 1,
                    top: "-1000%"
                }, 500, function() {
                    $(this).toggleClass("in out").parents(modal).removeClass('show').children(".modal-content").removeAttr("style");;
                });
                return false;
            });
        ...
        this.click(function(e) {
            ...
            if ($(".sidebar").hasClass("show")) {
                ...
                if (!$(e.target).is('.modal-content *,.modal-toggle')) {
                    $(".modal.show").children('.modal-content').addClass("out").animate({
                        opacity: 1,
                        top: "-1000%"
                    }, 500, function() {
                        $(this).toggleClass("in out").parents(".modal").removeClass('show').children(".modal-content").removeAttr("style");
...
$(this).click(function(e) {
    if ($(".dropdown-menu").hasClass("show")) {
        if (!$(e.target).is(".dropdown-toggle *,.dropdown-menu,.dropdown-toggle,.dropdown-menu *")) {
            ...
            if ($(".dropdown-menu").parents().hasClass('navbar') == true && window.innerWidth <= 768) {
                return true;
            } else {
                $(".dropdown-menu.show").toggleClass("show out").animate({ opacity: "toggle" }, 400,
                    function() {
                        $(this).removeClass("out").removeAttr('style');
                    });
            }
            if (window.resize) {
                $(".dropdown-menu").removeClass("show out").removeAttr('style');
            }
...
$(function(e) {
    ...
    $('.range').each(function() {
        ...
        this.innerHTML += "<style>#" + this.id + " input[type=range]::-webkit-slider-runnable-track {background:linear-gradient(to right, #e91e63 0%, #e91e63 " + n + "%, #e91e63 " + n + "%)} #" + this.id + ":hover input[type=range]:before{content:'" + n + "'!important;left: " + x + "px;} #" + this.id + ":hover input[type=range]:after{left: " + x + "px}</style>";
        i++
    });
...
$(document).ready(function() {
    ...
    $(".btn:not(.btn-white),.navbar:not(.white) .nav-item>.item,.nav-item > .item.dropdown .dropdown-toggle ").not(".dropdown-menu,.dropdown-menu .item,.dropdown").addClass("waves-effect waves-light");
    $(".navbar.white .nav-item>.item:not(.dropdown) ,.btn-white").addClass("waves-effect waves-ripple waves-teal");
    $("pre").addClass("scrolspy");
    $(window).resize(function() {
        $(".dropdown-menu").removeClass("show out").hide();
    });
});